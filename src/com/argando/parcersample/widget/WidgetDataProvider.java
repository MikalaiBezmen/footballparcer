...
class WidgetData {
    ...
    WidgetData(String team1, String time, String team2) {
        mTeam1  =   team1;
        mTime   =   time;
        mTeam2  =   team2;
    }
...
public class WidgetDataProvider extends ContentProvider{
    ...
    public static class Columns {
        ...
        public static final String TIME     = "time"; // ih this column may be score
...
//        }
    ...
    public synchronized Cursor query(Uri uri, String[] projection, String selection,
        ...
        final MatrixCursor c = new MatrixCursor(
                new String[]{ Columns.TEAM1, Columns.TIME, Columns.TEAM2});
        for (int i = 0; i < mData.size(); ++i) {
            final WidgetData data = mData.get(i);
            c.addRow(new Object[]{ data.mTeam1, data.mTime, data.mTeam2 });
        }
        return c;
    }
